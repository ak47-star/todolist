<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form method="POST" id="modal-add-todo" action="index.php?controller=ToDo&action=create">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="" id="example-text-input" name="task_name" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-date-input" class="col-2 col-form-label">Start</label>
                        <div class="col-10">
                            <input class="form-control date-start-add" type="date" value="" id="example-date-input" name="start_date" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-date-input" class="col-2 col-form-label">End</label>
                        <div class="col-10">
                            <input class="form-control date-end-add" type="date" value="" id="example-date-input" name="end_date" required>
                        </div>
                    </div>
                    <fieldset class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="gridRadios3" value="3">
